...
Dependencies.prototype.resolve = function(fn) {
  ...
  var resolveStep = function() {
    ...
    // TODO is there an easy way to pluck the first value from an object? -Tom
    // var resolvingPkg = _.find(unresolved, _.identity);
    // TODO do you like this better? less terse but more expressive (i think) -Mike
    var resolvingPkg = _.first(_.values(unresolved));
