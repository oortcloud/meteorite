...
Dependencies.prototype.resolved = function() {
  ...
  return this.packages && (!_.isEmpty(this.packages) || _.isEmpty(this.basePackages));
};
...
Dependencies.newFromLockFile = function(project) {
  ...
  return Dependencies.newFromLockJson(project, lockData);
};
      ...
      resolvingPkg.dependencies.resolve(function() {
        ...
        _.each(resolvingPkg.dependencies.packages, function(newPkg, newPkgName) {
          ...
          if (matched) {
            ...
            if (!matched.equals(resolvingPkg)) {
