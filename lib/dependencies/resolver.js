  ...
  if (existing) {
    ...
    if (current.conflictsWith(existing)) {
      ...
      if (self.forceDeps && current.overrides(existing)) {
        ...
        return fn(new PackageConflictError("Can't resolve dependencies! Use --force if you don't mrt taking a wild guess and running your app anway.", self.conflicts));
      }
    }
