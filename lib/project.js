...
Project.prototype.install = function(onComplete) {
  var self = this;
...
Project.prototype.run = function(onComplete) {
  this.install(onComplete);
};

Project.prototype._installMeteor = function(onComplete) {
  var self = this;
...
Project.prototype._parseRepoConfig = function(config) {
  return {
    checkout: 'branch',
...
Project.prototype._parseDeps = function() {
...
// TODO not DRY
Project.prototype._findMeteoriteDir = function() {
  var homeDir = process.env.HOME;
  this.meteoriteDir = path.join(homeDir, '.mrt');
};

Project.prototype._prepareMeteorDep = function() {
