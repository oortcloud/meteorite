...
Project = function(root, meteorArgs) {
  ...
  this.dependencies = new Dependencies(this.root, this.config.packages);
  ...
  this.installed = fs.existsSync(this.installRoot);
};
...
Project.prototype.fetch = function(fn) {
  ...
  // Fetch the packages
  self.dependencies.fetch(function() {
...
Project.prototype.writeSmartJson = function(fn) {
  ...
  // Write to disk
  // TODO use sync version writeFile, and convert this method to sync
