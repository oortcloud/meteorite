...
GitSource.prototype._getCommit = function(fn) {
  var self = this;
  var child = exec('git rev-parse HEAD', { cwd: self.sourcePath }, function (err, stdout) {
    self.commit = stdout.trim();
    fn();
  });
};
