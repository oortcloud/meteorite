...
GitSource = function(basePath, config) {
  ...
  // Apply configuration
  this.checkoutType = this._checkoutType(config);
...
GitSource.prototype.packagePath = function() {
  ...
  return path.join(this.basePath, namespace, this.checkoutType, this.head);
};
...
GitSource.prototype.prepare = function(fn) {
  var self = this;
