...
Package.prototype._gitPull = function(onDone) {
  var self = this;
...
Package.prototype._gitClone = function(onDone) {
  var self = this;
...
Package.prototype._gitCheckout = function(onDone) {
  var self = this;
...
Package.prototype.prepare = function(onDone) {
  var self = this;

  var checkout = function() {
    self._gitCheckout(onDone);
    if (this.name !== 'meteor')
      self._linkPackage();
  };
...
Package.prototype._linkPackage = function(name, linkPath, onDone) {
...
Package.prototype._findMeteor = function(onDone) {
  var self = this;
