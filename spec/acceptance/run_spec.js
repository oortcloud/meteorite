...
describe('invoking `mrt run`', function() {
  ...
  describe('in a non-meteor project directory', function(done) {
  ...
  describe('in a meteor project without a smart.json', function(done) {
  ...
  describe('in a meteor project with a smart.json', function(done) {
    ...
    describe("and the smart.json specifies a smart package from a path", function(done) {
